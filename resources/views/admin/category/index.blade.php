        ...
        <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="categoryTitle" type="text" placeholder="Enter Your Category Title" class="form-control">
                        @error('categoryTitle')
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" cols="30" rows="10" name="categoryDescription" class="form-control" placeholder="Enter Your Category Description"></textarea>
